...
function getAccounts() {
  ...
  function viewTransactions(){
    ...
    console.log(endDate);
    $.get("/viewTransactions/", { account_id: accIdSelected, startdate: startDate, enddate: endDate})
    .done(function (data) {
  ...
  function searchTransactions(){
    ...
    .fail(function (data) {
        ...
        $("#searchTransactionsErrMsg").text("Failed to search! Please try again!");
        $("#searchTransactionsErrMsg").show(); 
    });
