...
var sql6 = "INSERT into `Bank`.Transaction(id,source_account_id,description,amount,date,destination_account_id) values (?,?,?,?,?,?);UPDATE `Bank`.Account SET balance =? where id =?";
...
function billPaymentRecurring(req, res, next) {
    billPaymentRecurringHelper(mySQL, req, res, next);
}
router.post('/', billPaymentRecurring);

module.exports = router;
module.exports.billPaymentRecurringHelper = billPaymentRecurringHelper;
